...
import com.meiscoolx2.epicmod.entity.client.GoldWalkerEntityRenderState;
...
public class GoldWalkerEntityModel extends EntityModel<GoldWalkerEntityRenderState> {
    private final ModelPart head;
    private final ModelPart right_leg;
    private final ModelPart left_leg;

    public GoldWalkerEntityModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(GoldWalkerEntityRenderState state) {
